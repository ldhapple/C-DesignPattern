...
{
public:
	virtual void ConstructWorkTime(Alba* ceo) = 0;
	virtual void ConstructSalary(Alba* ceo) = 0;
	virtual void ConstructName(Alba* ceo) = 0;
};
...
public:
	...
	virtual void SetCeoBuilder(CeoBuilder* ceoBuilder) {}
